...
; 4MHzQuartz /1 * 24 / 2 => 48MHz	; check _CONFIG1
...
baud EQU 115200			; the desired baud rate
    ...
    __config	_CONFIG2L, _PWRT_OFF_2L & _BOR_OFF_2L  & _VREGEN_OFF_2L
    __config	_CONFIG2H, _WDT_OFF_2H & _WDTPS_32768_2H
    __config	_CONFIG3H, _CCP2MX_ON_3H & _PBADEN_OFF_3H  & _MCLRE_ON_3H
